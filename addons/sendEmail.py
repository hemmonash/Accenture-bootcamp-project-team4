...
def sendMailToScrumMaster(defect_obj):
    ...
    msg['To'] = "hnmal2@student.monash.edu" #"asfiya.memon@accenture.com" #["febinaly@getnada.com", "aditivenkateshr@gmail.com", "asfiya.memon@accenture.com", "krishnendu.c.das@accenture.com", "chethzz@hotmail.com", "peter.liang.official@gmail.com", "riababyc@gmail.com"]
    ...
    <body>
        ...
        <table style="background-color: #eceeef;" class="table">
        <thead>
            <tr>
